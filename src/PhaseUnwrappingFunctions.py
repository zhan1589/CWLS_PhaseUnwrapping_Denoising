...
from UnwrappingWLS4D import PhaseUnwrappingWeightedLeastSquares4D


def phase_unwrapping_WLS_initialized(Xn,Yn,Zn,Un,Vn,Wn,U0,V0,W0,fluid_maskn,fluid_mask0,unwrapping_maskn,Mag,phase_offset_correction='ref',
                                     val_addref_uvw=None, mask_addref_uvw=None, sigma_addref_uvw=None):
  ...
  Inputs:
    ...
    Mag: 3D array of the magnitude of the phase data. 
  ...
  unwrapping_tool = PhaseUnwrappingWeightedLeastSquares4D(Xn,Yn,Zn,Un,Vn,Wn,fluid_maskn,unwrapping_maskn)
  ...
  unwrapping_tool.phase_diff_unc_mag(Mag,Mag,Mag)
  unwrapping_tool.phase_diff_error_combined()
  unwrapping_tool.weights_from_errors()
  print('Constructing linear system')
  unwrapping_tool.construct_linear_system_WLS()
  print('Solving linear system')
  # unwrapping_tool.solve_linear_system_WLS_augmented_direct()
  unwrapping_tool.solve_linear_system_WLS_lsqr(Phase_u_0=U0, Phase_v_0=V0, Phase_w_0=W0)
  for vel_key in ['U','V','W']:
...
def phase_unwrapping_WLS_4D(Xn,Yn,Zn,Un,Vn,Wn,fluid_maskn,unwrapping_maskn,Mag,ct_start=None,ct_end=None,phase_offset_correction='ref',
                            val_addref_uvw=None, mask_addref_uvw=None, sigma_addref_uvw=None):
  ...
  Inputs:
    ...
    Mag: 4D array of the magnitude of the phase data. 
  ...
  for ct in range(Nt):
    unwrapping_tool = PhaseUnwrappingWeightedLeastSquares4D(Xn,Yn,Zn,Un[ct],Vn[ct],Wn[ct],fluid_maskn[ct],unwrapping_maskn[ct])
  ...
  unwrapping_tool = PhaseUnwrappingWeightedLeastSquares4D(Xn,Yn,Zn,Un[ct_start],Vn[ct_start],Wn[ct_start],fluid_maskn[ct_start],unwrapping_maskn[ct_start])
  ...
  unwrapping_tool.phase_diff_error_pole()
  unwrapping_tool.phase_diff_error_divergence()
  unwrapping_tool.phase_diff_unc_mag(Mag[ct_start],Mag[ct_start],Mag[ct_start])
  unwrapping_tool.phase_diff_error_combined()
  unwrapping_tool.weights_from_errors()
  print('Constructing linear system')
  unwrapping_tool.construct_linear_system_WLS()
  ...
  for ct_sequence in range(len(sequence_1)-1):
    ...
    Phase_unwrapped['U'][ct], Phase_unwrapped['V'][ct], Phase_unwrapped['W'][ct] = \
      phase_unwrapping_WLS_initialized(Xn,Yn,Zn,Un[ct],Vn[ct],Wn[ct],Phase_initial['U'],Phase_initial['V'],Phase_initial['W'],
                                       fluid_maskn[ct],fluid_maskn[ct_0],unwrapping_maskn[ct],Mag[ct],phase_offset_correction=phase_offset_correction,
